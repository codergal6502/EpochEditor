...
public class InventoryViewModel : ReactiveObject
{
    ...
    private GameSlotViewModel _sramViewModel;
    private SramUtilities.InventoryItem[] _inventory;

    public InventoryViewModel(GameSlotViewModel gameSlotViewModel, SramUtilities.InventoryItem[] inventory)
    {
        this._sramViewModel = gameSlotViewModel;
    ...
    public class InventoryItem : ReactiveObject {
        private readonly GameSlotViewModel _sramViewModel;
        ...
        public InventoryItem(GameSlotViewModel sramViewModel, SramUtilities.InventoryItem sramItem, SramUtilities.InventoryItem[] inventory, List<GameItem> gameItems, int itemSlot)
        {
        ...
        public int GameItemIndex {
            ...
            set { 
                if (false == _sramViewModel.IsSramLoading()) {
        ...
        public Byte ItemCount {
            ...
            set { 
                if (false == _sramViewModel.IsSramLoading() && _inventory[_itemSlot].ItemCount != value ) {
