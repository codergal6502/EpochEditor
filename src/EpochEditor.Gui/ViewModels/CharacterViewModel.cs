...
public class CharacterViewModel : ReactiveObject {
    ...
    public short    HitPoints           { get { return SramCharacterSheet.HitPoints;           } set { if (false == _gameSlotViewModel.IsSramLoading() && SramCharacterSheet.HitPoints != value)           { SramCharacterSheet.HitPoints = value;           _gameSlotViewModel.RaiseSlotChecksumChange(); this.RaisePropertyChanged(); } } }
    public short    MaxHitPoints        { get { return SramCharacterSheet.MaxHitPoints;        } set { if (false == _gameSlotViewModel.IsSramLoading() && SramCharacterSheet.MaxHitPoints != value)        { SramCharacterSheet.MaxHitPoints = value;        _gameSlotViewModel.RaiseSlotChecksumChange(); this.RaisePropertyChanged(); } } }
    public short    MagicPoints         { get { return SramCharacterSheet.MagicPoints;         } set { if (false == _gameSlotViewModel.IsSramLoading() && SramCharacterSheet.MagicPoints != value)         { SramCharacterSheet.MagicPoints = value;         _gameSlotViewModel.RaiseSlotChecksumChange(); this.RaisePropertyChanged(); } } }
    public short    MaxMagicPoints      { get { return SramCharacterSheet.MaxMagicPoints;      } set { if (false == _gameSlotViewModel.IsSramLoading() && SramCharacterSheet.MaxMagicPoints != value)      { SramCharacterSheet.MaxMagicPoints = value;      _gameSlotViewModel.RaiseSlotChecksumChange(); this.RaisePropertyChanged(); } } }
    public byte     BasePower           { get { return SramCharacterSheet.BasePower;           } set { if (false == _gameSlotViewModel.IsSramLoading() && SramCharacterSheet.BasePower != value)           { SramCharacterSheet.BasePower = value;           _gameSlotViewModel.RaiseSlotChecksumChange(); this.RaisePropertyChanged(); } } }
    public byte     BaseStamina         { get { return SramCharacterSheet.BaseStamina;         } set { if (false == _gameSlotViewModel.IsSramLoading() && SramCharacterSheet.BaseStamina != value)         { SramCharacterSheet.BaseStamina = value;         _gameSlotViewModel.RaiseSlotChecksumChange(); this.RaisePropertyChanged(); } } }
    public byte     BaseSpeed           { get { return SramCharacterSheet.BaseSpeed;           } set { if (false == _gameSlotViewModel.IsSramLoading() && SramCharacterSheet.BaseSpeed != value)           { SramCharacterSheet.BaseSpeed = value;           _gameSlotViewModel.RaiseSlotChecksumChange(); this.RaisePropertyChanged(); } } }
    public byte     BaseMagic           { get { return SramCharacterSheet.BaseMagic;           } set { if (false == _gameSlotViewModel.IsSramLoading() && SramCharacterSheet.BaseMagic != value)           { SramCharacterSheet.BaseMagic = value;           _gameSlotViewModel.RaiseSlotChecksumChange(); this.RaisePropertyChanged(); } } }
    public byte     BaseHit             { get { return SramCharacterSheet.BaseHit;             } set { if (false == _gameSlotViewModel.IsSramLoading() && SramCharacterSheet.BaseHit != value)             { SramCharacterSheet.BaseHit = value;             _gameSlotViewModel.RaiseSlotChecksumChange(); this.RaisePropertyChanged(); } } }
    public byte     BaseEvade           { get { return SramCharacterSheet.BaseEvade;           } set { if (false == _gameSlotViewModel.IsSramLoading() && SramCharacterSheet.BaseEvade != value)           { SramCharacterSheet.BaseEvade = value;           _gameSlotViewModel.RaiseSlotChecksumChange(); this.RaisePropertyChanged(); } } }
    public byte     BaseMagicDefense    { get { return SramCharacterSheet.BaseMagicDefense;    } set { if (false == _gameSlotViewModel.IsSramLoading() && SramCharacterSheet.BaseMagicDefense != value)    { SramCharacterSheet.BaseMagicDefense = value;    _gameSlotViewModel.RaiseSlotChecksumChange(); this.RaisePropertyChanged(); } } }
    ...
    public byte     Helmet              { get { return SramCharacterSheet.Helmet;              } set { if (false == _gameSlotViewModel.IsSramLoading() && SramCharacterSheet.Helmet != value)              { SramCharacterSheet.Helmet = value;              _gameSlotViewModel.RaiseSlotChecksumChange(); this.RaisePropertyChanged(); } } }
    public byte     Armor               { get { return SramCharacterSheet.Armor;               } set { if (false == _gameSlotViewModel.IsSramLoading() && SramCharacterSheet.Armor != value)               { SramCharacterSheet.Armor = value;               _gameSlotViewModel.RaiseSlotChecksumChange(); this.RaisePropertyChanged(); } } }
    public byte     Weapon              { get { return SramCharacterSheet.Weapon;              } set { if (false == _gameSlotViewModel.IsSramLoading() && SramCharacterSheet.Weapon != value)              { SramCharacterSheet.Weapon = value;              _gameSlotViewModel.RaiseSlotChecksumChange(); this.RaisePropertyChanged(); } } }
    public byte     Relic               { get { return SramCharacterSheet.Relic;               } set { if (false == _gameSlotViewModel.IsSramLoading() && SramCharacterSheet.Relic != value)               { SramCharacterSheet.Relic = value;               _gameSlotViewModel.RaiseSlotChecksumChange(); this.RaisePropertyChanged(); } } }
